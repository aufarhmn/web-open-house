...
const Hero = () => {
  return (
    <div className="flex flex-col items-center font-Poppins pt-10">
      <div className="px-16 leading-[85px] w-full text-white flex items-center justify-between flex-col lg:flex-row">
      ...
      <div className="w-full px-16 flex gap-16 text-[23px] justify-center lg:justify-start lg:mt-5">
