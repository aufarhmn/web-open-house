  ...
  return (
    <main className="overflow-hidden pb-10">
      <div className="flex flex-col items-center font-Poppins pt-10">
        ...
        <div
          className="w-full px-[5%] flex gap-5 xl:gap-16 sm:flex-row text-[23px] justify-center items-center flex-col xl:justify-start md:mt-5">
          <div
          ...
          <div
            className="cursor-pointer text-[#8A8D8F] bg-[#F9F9F9] flex justify-center items-center w-[80%] md:w-[192px] md:h-[60px] lg:h-[85px] rounded-[15px] border-[5px] border-[#E3E3E3] text-[18px] lg:text-[23px] h-[50px] hover:bg-[#E3E3E3]"
            onClick={() => {
              scrollToEvents();
            }}
            data-aos="fade-up"
