    ...
    return (
        ...
        <div className="w-full h-full px-7 md:px-16 pb-[120px]">
            <div className="grid container mx-auto space-y-20 md:space-y-32">
                ...
                <div className="flex items-start justify-between flex-col lg:flex-row gap-y-20 xl:gap-y-0 gap-x-10 xl:gap-x-[62px] font-Montserrat text-black-200 text-center" data-aos="fade-up" data-aos-duration="2000">
